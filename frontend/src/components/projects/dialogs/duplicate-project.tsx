...
import type { DuplicateProjectOptions } from "@/interface"
...
export default function DuplicateProjectDialog({ open, projectName, onOpenChange, onConfirm, isSubmitting }: DuplicateProjectDialogProps) {
            ...
            <DialogContent className="max-w-lg">
                ...
                <div className="space-y-5">
                    <div className="space-y-2">
                        ...
                        <Input id="dup-name" value={name} onChange={(e) => setName(e.target.value)} placeholder={defaultName} />
                    </div>
                            ...
                            <div>
                                ...
                                <div className="pl-6 pt-1 space-y-2">
                                    <label className="flex items-center gap-3">
                                        <Checkbox checked={keepTodosAssignees} onCheckedChange={(v) => setKeepTodosAssignees(Boolean(v))} disabled={!keepTodos} />
                                        <span>Assignees</span>
                                    </label>
                                    <label className="flex items-center gap-3">
                                        <Checkbox checked={keepTodosCompleted} onCheckedChange={(v) => setKeepTodosCompleted(Boolean(v))} disabled={!keepTodos} />
