...
import { ProjectBudgetEntry } from "@/lib/data/dummy-project-budgets"
import { Badge } from "@/components/ui/badge"
import { cn } from "@/lib/utils"

export const columns: ColumnDef<ProjectBudgetEntry>[] = [
    {
    ...
    },
    {
        ...
        header: () => <div className="text-right font-bold text-black">Budget</div>,
        cell: ({ row }) => {
